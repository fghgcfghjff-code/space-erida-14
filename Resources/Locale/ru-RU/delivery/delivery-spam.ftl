...
delivery-spam-13 = Письмо редактору.
    .desc = Письмо редактору.
    .content =
        Кому это может касаться,

        Знаменитая серия книг «Приключения Иана и Рено» — это то, что любят маленькие дети и как минимум одна крайне дислексичная ящерица (не переживайте, я исправился). Однако в издании была допущена ошибка, ведь Иан и Рено никогда бы не сделали ошибку в тексте. Похоже, что в книге «Приключения Иана и Рено: Арктическое путешествие мужества и дружбы» были использованы две строки из «Приключения Иана и Рено: Исследуя город».
        Это не имеет никакого смысла. Как Иан и Рено нашли маленького котёнка в Арктике? Что этот котёнок вообще там делал? Почему Иан и Рено сегодня делали больше обычного? А самый вопиющий пример — это вторая лишняя строка: «Когда день сменился ночью, они были измотаны, но счастливы после своего приключения в городе» (Иан и Рено, 1). ОЙ, ПРОСТИТЕ!!! Я ЧТО-ТО НЕ В КУРСЕ, ЧТО В АРКТИКЕ ЕСТЬ ГОРОД!!! В КОТОРЫЙ ОНИ ПРОСТО ЗАСКОЧИЛИ. НУ ЗНАЕТЕ. НА КОФЕ. ОЙ, ПОДОЖДИТЕ!! КОФЕ УБИВАЕТ СОБАК И ЛИС!!!!!!!!! КТО ЭТО ВООБЩЕ ОПУБЛИКОВАЛ!!!!! ВЫ ТОЛЬКО ЧТО УБИЛИ ИАНА И РЕНО!!!!!!!!!!!!!!!!!!! КАК ВЫ МОГЛИ!!!!!!!!!!!!!!!!!!! ВЫ ЧУДОВИЩЕ!!!!!!!!!!!!!!!!!
        И что вы получили, убив Иана и Рено? Мм? Немного более длинную книгу? Вам нужна была книга подлиннее, да? Длинные книги продаются дороже, верно? Вы хотели заработать больше денег?
        ПОСМОТРИТЕ, К ЧЕМУ ЭТО ПРИВЕЛО. ВЫ УБИЛИ ИХ ОБОИХ. ПОЗДРАВЛЯЮ.
        ТЕПЕРЬ ПРОДОЛЖЕНИЙ БОЛЬШЕ НЕ БУДЕТ.
        НУ КАК, ПОЛУЧИЛОСЬ ЗАРАБОТАТЬ???? НЕ ОЧЕНЬ-ТО????
