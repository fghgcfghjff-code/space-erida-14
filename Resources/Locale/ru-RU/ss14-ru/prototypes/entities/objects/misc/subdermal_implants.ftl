...
ent-InferiorImplant = имплант "подчинение"
    .desc = Этот имплант подчиняет разум имплантироемого воли того, кто приобрёл его в АпЛинке. Если он появился каким-то иным образом то, тому кто его ввёл.
