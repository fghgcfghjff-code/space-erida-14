using System.Linq;
using Content.Server._Erida.Language.Events;
...
using UniversalLanguageSpeakerComponent = Content.Shared._Erida.Language.Components.UniversalLanguageSpeakerComponent;
...
public sealed partial class LanguageSystem : SharedLanguageSystem
{
    ...
    // Erida start
    private void OnLanguageListChanged(Entity<LanguageKnowledgeComponent> ent, ref LanguageListUpdated ev)
    {
